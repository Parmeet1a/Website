...
let valOne = newArray.find((val) => val.id===3)
let valTwo = newArray.find((val) => val.id===3)
let valThird = newArray.find((val) => val.id===3)
let valFourth = newArray.find((val) => val.id===3)
let valFifth = newArray.find((val) => val.id===3)
let valSixth = newArray.find((val) => val.id===3)
let valSeventh = newArray.find((val) => val.id===3)
            ...
            <div className="list-head">
                <h1 className='font-bold ml-4 my-4'>What's included</h1>
                    ...
                    <div className="lists list-none text-slate-500">
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valOne.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valTwo.list}</li>
                    </div>
        ...
        <div className="box2 border-2 h-[650px] w-[300px] rounded-lg">
            ...
            <div className="list-head">
                <h1 className='font-bold ml-4 my-4'>What's included</h1>
                        ...
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valOne.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valTwo.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valThird.list}</li>
                    </div>
        ...
        <div className="box3 border-2 h-[650px] w-[300px] rounded-lg">
            ...
            <div className="list-head">
                <h1 className='font-bold ml-4 my-4'>What's included</h1>
                        ...
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valTwo.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valThird.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valFourth.list}</li>
                    </div>
        ...
        <div className="box4 border-2 h-[650px] w-[300px] rounded-lg">
            ...
            <div className="list-head">
                <h1 className='font-bold ml-4 my-4'>What's included</h1>
                        ...
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valThird.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valFourth.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valFifth.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valSixth.list}</li>
                        <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt='' />{valSeventh.list}</li>
                    </div>
