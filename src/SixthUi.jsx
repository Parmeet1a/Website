        ...
        <div className="main-container border-2 h-[700px] w-[1400px] flex justify-around items-center">
            <div className="box1 border-2  h-[650px] w-[300px] rounded-lg">
                ...
                <div className="lists list-none text-slate-500">
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit.</li>
                </div>
            </div>
            ...
            <div className="head">
                ...
                <div className="lists list-none  text-slate-500">
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum, dolor sit amet consectetur adipisi.</li>
                </div>
            </div>
            ...
            <div className="head">
                ...
                <div className="lists list-none text-slate-500">
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit amet, consectetur adipisi.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor, sit amet consectetur adipisicin.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit.</li>
                </div>
            </div>
            ...
            <div className="head">
                ...
                <div className="lists list-none text-slate-500">
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit amet consectetur.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit cwqd.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit.</li>
                    <li className='flex my-4'><img className='h-[20px] w-[20px] mx-4 mt-1' src="https://img.icons8.com/emoji/48/null/check-mark-emoji.png " alt=''/>Lorem ipsum dolor sit vsw ewax.</li>
                </div>
            </div>
